...
| Startturm/Wolken | 60.000–90.000 | `img/tilesets/launch-tower-tiles-clean-hd.png` | `launch-tower-far-clean-hd.png`, `launch-tower-mid-clean-hd.png`, `launch-tower-near-clean-hd.png` |
| Raumstation | 30.000–60.000 | `img/tilesets/space-station-tiles-clean-hd.png` | `space-station-far-clean-hd.png`, `space-station-mid-clean-hd.png`, `space-station-near-clean-hd.png` |
| Mond | 0–30.000 | `img/tilesets/moon-tiles-clean-hd.png` | `moon-far-clean-hd.png`, `moon-mid-clean-hd.png`, `moon-near-clean-hd.png` |
