...
const RUNTIME_FILE = "img/tilesets/space-station-tiles-clean-hd.png";
const MASTER_FILE =
  "img/concepts/approvals/space-station-clean-hd-tiles-production-layout-v1.png";
...
console.log("ART-020: 32 Clean-HD-Raumstationstiles bestanden.");
...
function verifyManifest() {
  ...
  const tiles = assets.find((asset) => asset.id === "space-station-tiles");
