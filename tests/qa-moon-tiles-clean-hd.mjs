...
const RUNTIME_FILE = "img/tilesets/moon-tiles-clean-hd.png";
const MASTER_FILE =
  "img/concepts/approvals/moon-clean-hd-tiles-production-layout-v1.png";
...
console.log("ART-021: 32 Clean-HD-Mondtiles bestanden.");
...
function verifyManifest() {
  ...
  const tiles = assets.find((asset) => asset.id === "moon-tiles");
