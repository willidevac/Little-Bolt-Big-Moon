...
const CHARACTER_CONFIG = Object.freeze({
  ...
  minimumJumpSpeedPixelsPerSecond: 500,
...
const WEAPON_DEFINITIONS = Object.freeze({
  ...
  arcCannon: Object.freeze({
    id: "arcCannon",
    name: "Lichtbogenkanone",
    type: "projectile",
    damage: 42,
    cooldownSeconds: 1.1,
    ammoCost: 1,
...
const WEAPONS_CONFIG = Object.freeze({
  order: Object.freeze(["repairWrench", "boltThrower", "arcCannon"]),
...
const PROJECTILE_CONFIG = Object.freeze({
  ...
  playerArc: Object.freeze({
    speedPixelsPerSecond: 430,
    lifetimeSeconds: 1.05,
    worldPaddingPixels: 64,
    animationFrameDurationSeconds: 0.07,
    chainRangePixels: 160,
    secondaryDamageMultiplier: 0.5,
  }),
  boss: Object.freeze({
    shockwave: Object.freeze({
      speedPixelsPerSecond: 460,
      lifetimeSeconds: 1.6,
      worldPaddingPixels: 64,
      animationFrameDurationSeconds: 0.08,
    }),
    moonBolt: Object.freeze({
      speedPixelsPerSecond: 380,
      lifetimeSeconds: 2.4,
      worldPaddingPixels: 64,
...
const ENEMY_CONFIG = Object.freeze({
  ...
  moonWarden: Object.freeze({
    ...
    activationDistancePixels: 430,
    movementStopDistancePixels: 144,
    initialPursuitSeconds: 1,
...
const AUDIO_CONFIG = Object.freeze({
  ...
  effects: Object.freeze({
    ...
    arc: createEffect("boss-attack.ogg", 0.25, 2, 250),
